...
export const MULTILINGUAL_CROPS = {
  'paddy': {
    en: 'Paddy / Rice (Swarna Grade-A)',
    hi: 'धान / चावल (स्वर्णा ग्रेड-ए)',
    mr: 'भात / तांदूळ (स्वर्णा अ-श्रेणी)',
    or: 'ଧାନ / ଚାଉଳ (ସ୍ୱର୍ଣ୍ଣା ଗ୍ରେଡ-ଏ)',
    pa: 'ਝੋਨਾ / ਚੌਲ (ਸਵਰਨਾ ਗ੍ਰੇਡ-ਏ)',
    ml: 'നെല്ല് / അരി (സ്വർണ്ണ ഗ്രേഡ്-എ)'
  },
  'rice': {
    en: 'Paddy / Rice (Swarna Grade-A)',
    hi: 'धान / चावल (स्वर्णा ग्रेड-ए)',
  ...
  'wheat': {
    en: 'Wheat (Kalyan Sona Sharbati)',
    hi: 'गेहूं (कल्याण सोना शरबती)',
    mr: 'गहू (कल्याण सोना शरबती)',
    or: 'ଗହମ (କଲ୍ୟାଣ ସୋନା ଶରବତୀ)',
    pa: 'ਕਣਕ (ਕਲਿਆਣ ਸੋਨਾ ਸ਼ਰਬਤੀ)',
    ml: 'ഗോതമ്പ് (കല്യാൺ സോണ ശർബതി)'
  },
  'cotton': {
    en: 'Cotton (Bt-II White Gold)',
    hi: 'कपास (बीटी-II सफेद सोना)',
    mr: 'कापूस (बीटी-II पांढरे सोने)',
    or: 'କପା (ବିଟି-II ଧଳା ସୁନା)',
    pa: 'ਕਪਾਹ / ਨਰਮਾ (ਬੀਟੀ-II ਚਿੱਟਾ ਸੋਨਾ)',
    ml: 'പരുത്തി (ബിടി-II വെള്ള വെള്ളി)'
  },
  'soybean': {
    en: 'Soybean (JS-335 Yellow Gold)',
    hi: 'सोयाबीन (जेएस-335 पीला सोना)',
    mr: 'सोयाबीन (जेएस-335 पिवळे सोने)',
    or: 'ସୋୟାବିନ (ଜେଏସ-335 ହଳଦିଆ ସୁନା)',
    pa: 'ਸੋਇਆਬੀਨ (ਜੇਐਸ-335 ਪੀਲਾ ਸੋਨਾ)',
    ml: 'സോയാബീൻ (JS-335 യെല്ലോ ഗോൾഡ്)'
  },
  'soyabean': {
    en: 'Soybean (JS-335 Yellow Gold)',
    hi: 'सोयाबीन (जेएस-335 पीला सोना)',
  ...
  'tomato': {
    en: 'Tomato (Hybrid Vaishali)',
    hi: 'टमाटर (हाइब्रिड वैशाली)',
    mr: 'टोमॅटो (हायब्रिड वैशाली)',
    or: 'ବିଲାତି ବାଇଗଣ / ଟମାଟୋ (ହାଇବ୍ରିଡ ବୈଶାଳୀ)',
    pa: 'ਟਮਾਟਰ (ਹਾਈਬ੍ਰਿਡ ਵੈਸ਼ਾਲੀ)',
    ml: 'തക്കാളി (ഹൈബ്രിഡ് വൈശാലി)'
  },
  'onion': {
    en: 'Onion (Nashik Red Garwa)',
    hi: 'प्याज (नासिक लाल गरवा)',
    mr: 'कांदा (नाशिक लाल गरवा)',
    or: 'ପିଆଜ (ନାସିକ ଲାଲ ଗରୱା)',
    pa: 'ਗੰਢਾ / ਪਿਆਜ਼ (ਨਾਸਿਕ ਲਾਲ ਗਰਵਾ)',
    ml: 'സവാള (നാസിക് റെഡ് ഗാർവ)'
  },
  'potato': {
    en: 'Potato (Kufri Jyoti)',
    hi: 'आलू (कुफरी ज्योति)',
    mr: 'बटाटा (कुफरी ज्योती)',
    or: 'ଆଳୁ (କୁଫ୍ରି ଜ୍ୟୋତି)',
    pa: 'ਆਲੂ (ਕੁਫਰੀ ਜਯੋਤੀ)',
    ml: 'ഉരുളക്കിഴങ്ങ് (കുഫ്രി ജ്യോതി)'
  },
  'maize': {
    en: 'Maize / Corn (HQPM-1)',
    hi: 'मक्का (एचक्यूपीएम-1)',
    mr: 'मका (एचक्यूपीएम-1)',
    or: 'ମକା (HQPM-1)',
    pa: 'ਮੱਕੀ (ਐਚਕਿਊਪੀਐਮ-1)',
    ml: 'ചോളം (HQPM-1)'
  ...
  'urad': {
    en: 'Black Gram / Urad (PU-31)',
    hi: 'उड़द (पीयू-31)',
    mr: 'उडीद (पीयू-31)',
    or: 'ବିରି / କଳା ମୁଗ (PU-31)',
    pa: 'ਮਾਂਹ / ਉੜਦ (ਪੀਯੂ-31)',
    ml: 'ഉഴുന്ന് (PU-31)'
  },
  'tur': {
    en: 'Pigeon Pea / Tur / Arhar (BDN-711)',
    hi: 'अरहर / तुअर (बीडीएन-711)',
    mr: 'तूर (बीडीएन-711)',
    or: 'ହରଡ଼ (BDN-711)',
    pa: 'ਅਰਹਰ / ਤੂਰ (ਬੀਡੀਐਨ-711)',
    ml: 'തുവരപ്പരിപ്പ് (BDN-711)'
  },
  'arhar': {
    en: 'Pigeon Pea / Tur / Arhar (BDN-711)',
    hi: 'अरहर / तुअर (बीडीएन-711)',
  ...
  'chana': {
    en: 'Bengal Gram / Chana (JG-11)',
    hi: 'चना (जेजी-11)',
    mr: 'हरभरा / चना (जेजी-11)',
    or: 'ବୁଟ / ଚଣା (JG-11)',
    pa: 'ਛੋਲੇ / ਚਣਾ (ਜੇਜੀ-11)',
    ml: 'കടല (JG-11)'
  },
  ...
  'ginger': {
    en: 'Ginger (Wayanad Mahima)',
    hi: 'अदरक (वायनाड महिमा)',
    mr: 'आले / अद्रक (वायनाड महिमा)',
    or: 'ଅଦା (ୱାୟାନାଡ ମହିମା)',
    pa: 'ਅਦਰਕ (ਵਾਇਨਾਡ ਮਹਿਮਾ)',
    ml: 'ഇഞ്ചി (വയനാട് മഹിമ)'
  },
  'chilli': {
    en: 'Green & Red Chilli (Guntur Teja)',
    hi: 'मिर्च (गुंटूर तेजा)',
    mr: 'मिरची (गुंटूर तेजा)',
    or: 'ଲଙ୍କା (ଗୁଣ୍ଟୁର ତେଜା)',
    pa: 'ਮਿਰਚ (ਗੁੰਟੂਰ ਤੇਜਾ)',
    ml: 'മുളക് (ഗുണ്ടൂർ തേജ)'
  },
  'coconut': {
    en: 'Coconut (West Coast Tall)',
    hi: 'नारियल (वेस्ट कोस्ट टॉल)',
    mr: 'नारळ (वेस्ट कोस्ट टॉल)',
    or: 'ନଡ଼ିଆ (ୱେଷ୍ଟ କୋଷ୍ଟ ଟଲ୍)',
    pa: 'ਨਾਰੀਅਲ (ਵੈਸਟ ਕੋਸਟ ਟਾਲ)',
    ml: 'തേങ്ങ (വെസ്റ്റ് കോസ്റ്റ് ടോൾ)'
  },
  'turmeric': {
    en: 'Turmeric (Salem / Pragati)',
    hi: 'हल्दी (सेलम / प्रगति)',
    mr: 'हळद (सेलम / प्रगती)',
    or: 'ହଳଦୀ (ସାଲେମ / ପ୍ରଗତି)',
    pa: 'ਹਲਦੀ (ਸਲੇਮ / ਪ੍ਰਗਤੀ)',
    ml: 'മഞ്ഞൾ (സേലം / പ്രഗതി)'
  },
  'cardamom': {
    en: 'Green Cardamom (Njallani)',
    hi: 'हरी इलायची (न्याल्लानी)',
    mr: 'हिरवी वेलची (न्याल्लानी)',
    or: 'ଗୁଜୁରାତି / ଅଳେଇଚ (ନ୍ୟାଲ୍ଲାନି)',
    pa: 'ਛੋਟੀ ਇਲਾਇਚੀ (ਨਿਆਲਾਨੀ)',
    ml: 'ഏലം (ഞള്ളാനി)'
  },
  'rubber': {
    en: 'Natural Rubber (RRII 105)',
    hi: 'प्राकृतिक रबर (आरआरआईआई 105)',
    mr: 'नैसर्गिक रबर (आरआरआईआय 105)',
    or: 'ପ୍ରାକୃତିକ ରବର (RRII 105)',
    pa: 'ਕੁਦਰਤੀ ਰਬੜ (ਆਰਆਰਆਈਆਈ 105)',
    ml: 'റബ്ബർ (RRII 105)'
  },
  'bajra': {
    en: 'Pearl Millet / Bajra (HHB-67)',
    hi: 'बाजरा (एचएचबी-67)',
    mr: 'बाजरी (एचएचबी-67)',
    or: 'ବାଜରା (HHB-67)',
    pa: 'ਬਾਜਰਾ (ਐਚਐਚਬੀ-67)',
...
export function getCropDisplayName(cropName, currentLang = 'en') {
  if (!cropName) return '';
  const key = cropName.toLowerCase().trim();
  for (const [cropKey, langMap] of Object.entries(MULTILINGUAL_CROPS)) {
    if (key.includes(cropKey) || cropKey.includes(key)) {
      return langMap[currentLang] || langMap.en || cropName;
    }
  }
  return cropName;
}
